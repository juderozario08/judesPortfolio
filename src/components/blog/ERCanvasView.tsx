...
export const ERCanvasView = ({
  ...
  return (
    ...
    >
        ...
        {RADIUS_SCHEMA_TABLES.map((table) => {
          ...
          return (
            <div
              ...
              className={`rounded-xl border transition-all duration-150 cursor-pointer shadow-sm select-none z-10 ${
                isSelected
                  ? 'bg-tokyo-surface border-tokyo-purple ring-2 ring-tokyo-purple/60  scale-[1.02]'
                  : isHovered
                  ? 'bg-tokyo-surface border-tokyo-cyan '
      ...
      <div className="absolute bottom-4 left-4 bg-tokyo-base/95 backdrop-blur-md border border-tokyo-surface rounded-xl px-3.5 py-2 text-xs font-mono text-tokyo-muted pointer-events-none hidden sm:flex items-center gap-2.5 shadow-sm">
